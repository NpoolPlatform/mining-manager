...
const (
	// Label holds the string label denoting the profitunsold type in the database.
	Label = "profit_unsold"
	...
	// Table holds the table name of the profitunsold in the database.
	Table = "profit_unsolds"
)

// Columns holds all SQL columns for profitunsold fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
