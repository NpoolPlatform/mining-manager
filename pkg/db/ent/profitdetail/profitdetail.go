...
const (
	// Label holds the string label denoting the profitdetail type in the database.
	Label = "profit_detail"
	...
	// Table holds the table name of the profitdetail in the database.
	Table = "profit_details"
)

// Columns holds all SQL columns for profitdetail fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
