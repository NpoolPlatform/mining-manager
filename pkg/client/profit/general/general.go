...
type handler func(context.Context, npool.ProfitGeneralClient) (cruder.Any, error)
...
func withCRUD(ctx context.Context, handler handler) (cruder.Any, error) {
	...
	cli := npool.NewProfitGeneralClient(conn)

	return handler(_ctx, cli)
}

func CreateGeneral(ctx context.Context, in *npool.GeneralReq) (*npool.General, error) {
	info, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ProfitGeneralClient) (cruder.Any, error) {
...
func CreateGenerals(ctx context.Context, in []*npool.GeneralReq) ([]*npool.General, error) {
	infos, err := withCRUD(ctx, func(_ctx context.Context, cli npool.ProfitGeneralClient) (cruder.Any, error) {
