# Npool mining manager

[![Test](https://github.com/NpoolPlatform/mining-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/mining-manager/actions/workflows/main.yml)
...
* make mining-manager ```单独编译服务```
* make mining-manager-image ```单独生成服务镜像```
